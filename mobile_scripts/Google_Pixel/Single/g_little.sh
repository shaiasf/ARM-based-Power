...
LITTLE_CORES="0 1 2 3"    # Define LITTLE cluster cores
BIG_CORES="4 5 6 7 8"                # Big cores (will be turned OFF)
...
setup_cgroups() {
  ...
  # Initially, system gets SYSTEM_CORE only (0)
